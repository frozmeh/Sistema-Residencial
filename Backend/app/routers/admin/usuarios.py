...
@router.get("/activos", response_model=list[schemas.UsuarioAdminOut])
...
@router.get("/buscar", response_model=list[schemas.UsuarioAdminOut])
def buscar_usuarios(query: str, db: Session = Depends(get_db), admin=Depends(verificar_admin)):
    return crud.buscar_usuarios(db, query)


@router.get("/buscar/nombre", response_model=schemas.UsuarioAdminOut)
...
@router.get("/buscar/email", response_model=schemas.UsuarioAdminOut)
...
@router.get("/{id_usuario}", response_model=schemas.UsuarioAdminOut)
...
@router.put("/{id_usuario}", response_model=schemas.UsuarioAdminOut)
...
@router.put("/{id_usuario}/rol", response_model=schemas.UsuarioAdminOut)
def cambiar_rol(
    id_usuario: int,
...
@router.put("/{id_usuario}/desactivar", response_model=schemas.UsuarioAdminOut)
...
@router.put("/{id_usuario}/reactivar", response_model=schemas.UsuarioAdminOut)
...
@router.put("/{id_usuario}/bloquear", response_model=schemas.UsuarioAdminOut)
...
@router.put("/{id_usuario}/cambiar-password", response_model=schemas.UsuarioAdminOut)
def resetear_password(
    id_usuario: int,
    datos: schemas.UsuarioUpdatePassword,
    db: Session = Depends(get_db),
    admin=Depends(verificar_admin),
    request: Request = None,
):
